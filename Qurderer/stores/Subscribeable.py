...
class Subscribeable:
    ...
    Attributes:
        _value (Any): The current value stored in the Subscribeable instance.
        _callbacks (List[Callable]): List of callback functions to be called when the value changes.
    """

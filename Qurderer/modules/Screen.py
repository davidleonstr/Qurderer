...
Functions provided:
    - Screen: A decorator that assigns a `name` attribute to a class and optionally reloads UI.
"""
        ...
        def removeAllLayouts(widget: QWidget):
            ...
            if layout is not None:
                while layout.count():
                    ...
                    if item.layout():
                        removeAllLayouts(item.layout())  # Llamada recursiva para limpiar layouts anidados
